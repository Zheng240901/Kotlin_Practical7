...
class FruitViewModel : ViewModel() {
    ...
    // TODO
    fun insert(f: Fruit) = viewModelScope.launch { db.fruitDao.insert(f) }

    // TODO
    fun update(f: Fruit) = viewModelScope.launch { db.fruitDao.insert(f) }

    // TODO
    fun delete(f: Fruit) = viewModelScope.launch { db.fruitDao.insert(f) }
    ...
    fun validate(f: Fruit): String {
        ...
        {
            err+= "- Price must be between 0.01 - 99.99. \n"
        }
